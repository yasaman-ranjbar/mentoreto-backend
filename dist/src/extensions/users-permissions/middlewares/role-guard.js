    ...
    return async (ctx, next) => {
        ...
        if (!user.customRole) {
            ...
            if (!allowedPaths.includes(currentPath)) {
                ctx.throw(403, "Please select your role (mentor or mentee) before accessing this resource", {
                    details: {
...
module.exports.requireRole = (requiredRole) => {
    return async (ctx, next) => {
        ...
        if (user.customRole !== requiredRole) {
            ctx.throw(403, `Access denied. This endpoint requires ${requiredRole} role.`, {
                details: {
